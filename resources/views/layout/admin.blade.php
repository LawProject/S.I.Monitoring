    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img class="brand-image " style="opacity: .8">
                <span class="brand-text font-weight-light"><b>S.I.Monitoring</b></span>
            </a>
              ...
              <li class="nav-item">
                <a href="./index3.html" class="nav-link">
                  ...
                  <p>Dashboard v3</p>
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link" style="background-color: #2c7375;">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link user-menu" style="background-color: #2c7375;">
