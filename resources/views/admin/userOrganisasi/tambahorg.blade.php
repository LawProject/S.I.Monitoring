...
@section('content')
    ...
    <body>
        <br>
        <br>
        <h1 class="text-center mb-4 mt-5">Tambah Pengguna Organisasi</h1>
        ...
        <div class="container mb-5">
            <div class="row justify-content-center">
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.tambahkanorrganisasi') }}" method="POST"
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nomor Induk Organisasi</label>
